   ...
   <form action="registe" method="post">
    <table  border="0" cellpadding="2" cellspacing="0">
     ...
     <tr><th>用户名:</th><td><input type="text" name="username"></td></tr>
          ...
          <tr><th>学校  ：   </th><td><input type="text" name="schoolname"></td></tr> 
          <tr><th>身份  ：</th><td><input type="radio" name="identy" value="1">学生<input type="radio" name="identy" value="2">家长
          <input type="radio" name="identy" value="3">教师</td></tr>
