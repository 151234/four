...
public final class Tcreateexam1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//班级导航连接 
      ...
      out.write("             font-size:14px;display:block;\"><a href=\"Tlogin.jsp\">我加入的班级</a></div>\r\n");
      ...
      out.write("             font-size:14px;display:block;\">><a href=\"Texamdetail.jsp\">作业详情</a></div>\r\n");
      out.write("           </div>\r\n");
      out.write("        \r\n");
      ...
      out.write("        <form action=\"createed.action\" method=\"post\">\r\n");
    ...
    int i=thepage;
        while(i<(pagesize+thepage)&&rowcount!=0&&i<number)
         {     
...
if(i%2==1)
      ...
      out.write("\r\n");
      out.write("           <tr bgcolor=\"#cccccc\"><td width=\"15%\" style=\"padding-left:450px;padding-top:15px\">题目");
      out.print(i+1 +". ");
      out.write("\r\n");
      out.write("           <input type=\"text\" name=\"question");
      out.print(i);
      out.write("\"></td>\r\n");
      out.write("              <td width=\"40%\"style=\"padding-top:15px\">=<input name=\"que");
      out.print(i );
      out.write("\"></td>\r\n");
      out.write("          ");
i++;}else{ 
      out.write("\r\n");
      out.write("        \r\n");
      out.write("         <tr><td width=\"15%\" style=\"padding-left:450px;padding-top:15px\">题目");
      out.print(i+1 +". ");
      out.write("\r\n");
      out.write("         <input type=\"text\" name=\"question");
      out.print(i );
...
if(curp>1)
    {
      out.write("\r\n");
      out.write("   <tr><th> <a href=\"Tcreateexam1.jsp?page=");
      out.print(curp-1);
...
if(curp<pagecount){ 
      out.write("\r\n");
      out.write("   <th>  <a href=\"Tcreateexam1.jsp?page=");
      out.print(curp+1);
      out.write("\">下一页</a></th> ");
