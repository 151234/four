...
public final class checkExam_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//状态栏 
      ...
      out.write("          text-align:center;font-size:16px\"><b>欢迎，教师，");
...
//班级导航连接 
      ...
      out.write("             font-size:14px;display:block;\">><a href=\"checkExam.jsp\">作业详情</a></div>\r\n");
      out.write("           </div>\r\n");
      out.write("        \r\n");
      ...
      out.write("        <form action=\"doexam.action\" method=\"post\">\r\n");
...
if(i%2==1)
      ...
      out.print(i+1 +". "+tt.getCurrenet().get(i).getContext() );
      out.write("</td>\r\n");
      out.write("             <td width=\"40%\"style=\"padding-top:15px\">=");
      out.print(tt.getCurrenet().get(i).getAnswer());
      out.write("</td>\r\n");
      out.write("          ");
i++;}else{ 
      out.write("\r\n");
...
i++;} 
      ...
      out.write("               ");
 if(check!=null){if(check.equals("1")){
      out.write("<a href=\"Tcreateexam2.jsp\">返回</a>");
}else{
      out.write("<input type=\"submit\" value=\"提交\" >");
} }else{
      out.write("<a href=\"Tbandetail.jsp\">返回</a> ");
}
      out.write("\r\n");
      out.write("               </div>\r\n");
      out.write("           </form>\r\n");
